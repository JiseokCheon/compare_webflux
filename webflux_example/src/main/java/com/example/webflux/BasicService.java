...
//                .flatMapIterable(obj -> objectMapper.convertValue(obj, AdTarget.class).getAdsNoList())
//                .flatMap(tK -> reactiveRedisOperations.opsForValue().get(tK));
//                .map(o -> objectMapper.convertValue(o, Ad.class))
//                .sort(Comparator.comparing(Ad::getWeight));
